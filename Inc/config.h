...
*/
  ...
  #define PRI_INPUT1            0, 0, 2048, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            1, 0, 2048, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
